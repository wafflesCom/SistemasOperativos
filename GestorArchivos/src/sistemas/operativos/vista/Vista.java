...
public class Vista extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
      if (evt.getKeyCode() == 96) {//0
        hilo.proceso(evt.getKeyCode());
        hilo.run();
       
        
      }
      if (evt.getKeyCode() == 97) {//1
        hilo.proceso(evt.getKeyCode());
        hilo.run();
      }
      if (evt.getKeyCode() == 98) {//2
        hilo.proceso(evt.getKeyCode());
        //hilo.run();
      }
      if (evt.getKeyCode() == 99) {//3
        hilo.proceso(evt.getKeyCode());
        //hilo.run();
      }
      if (evt.getKeyCode() == 100) {//4
        hilo.proceso(evt.getKeyCode());
        //hilo.run();
      }
      if (evt.getKeyCode() == 101) {//5
        hilo.proceso(evt.getKeyCode());
        hilo.run();
      }
